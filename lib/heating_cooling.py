...
def ent_heating(nWires:int,gate_set:tuple,nSteps:int=500,eps:float=1e-12,chi_max:int=None) -> tuple[MPS,dict]:
    """
...
def ent_cooling(state:MPS,gate_set:tuple,beta:float,nSteps:int=500,eps:float=1e-12,chi_max:int=None) -> tuple[MPS,dict]:
    """
